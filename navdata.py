...
def parseData( data, robot, verbose=False ):
    ...
    if frameId == 0x7F:
        ...
        #print "primerframeid", commandProject, commandClass, commandId
        if commandProject == 0:
        ...
        commandProject, commandClass, commandId = struct.unpack("BBH",  data[7:7+4])
        #print "segundoframeid", commandProject, commandClass, commandId
...
############ Ir a      out/arsdk-native/staging/usr/include/libARCommands/ARCOMMANDS_IDs.h
        ####

        elif (commandProject, commandClass) == (1,34):
            print commandId
        #ARCOMMANDS_ID_ARDRONE3_CLASS_PILOTINGEVENT = 34    line 75
            if commandId == 0:
            #ARCOMMANDS_ID_ARDRONE3_PILOTINGEVENT_CMD_MOVEBYEND = 0   line 296
                print("He llegado")    

                #state = struct.unpack("I", data[11:11+4])[0]
                robot.movementState = "end"
                print "movementState changed,   ended"        
